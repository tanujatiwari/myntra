      ...
      <div className="container mb-5">
          ...
          <div className="col-lg-2 col-md-3 col-6 mt-5">
            ...
            <ul className="list-unstyled pt-4">
              ...
              <li>
                Myntra Insider
                <span
                  className="badge rounded-pill bg-danger ml-2"
                  style={{ fontSize: "9px" }}
                >
                  NEW
                </span>
        ...
        <div className="pt-5" style={{ color: "#696B79", fontSize: "15px" }}>
          ...
          <div className="pt-3">
            ...
            | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes |
          ...
          <div style={{ color: "#94969F" }}>
            <div className="pt-3">
              ...
              <div className="footerAdd d-flex pb-3">
                <div>
                  ...
                  Varthur Hobli,<br></br>
                  Bengaluru – 560103, India<br></br>
                </div>
                <div className="ml-auto">
                  CIN: U72300KA2007PTC041799<br></br> Telephone:{" "}
                  <span className="text-primary">
                    <b>+91-80-61561999</b>
                  </span>
                </div>
            ...
            <div className="my-4">
              ...
              <ol className="pt-3">
                ...
                <li className="pt-2">
                  ...
                  <span style={{ fontSize: "14px" }}>
                    &nbsp;Online shopping for women at Myntra is a
                    mood-elevating experience. Look hip and stay comfortable
                    with chinos and printed shorts this summer. Look hot on your
                    date dressed in a little black dress, or opt for red dresses
                    for a sassy vibe. Striped dresses and T-shirts represent the
                    classic spirit of nautical fashion. Choose your favourites
                    from among Bardot, off-shoulder, shirt-style, blouson,
                ...
                <li className="pt-2">
                  ...
                  <span style={{ fontSize: "14px" }}>
                    &nbsp;While clothes maketh the man, the type of footwear you
                    wear reflects your personality. We bring you an exhaustive
                    lineup of options in casual shoes for men, such as sneakers
                    and loafers. Make a power statement at work dressed in
                    brogues and oxfords. Practice for your marathon with running
                    shoes for men and women. Choose shoes for individual games
                    such as tennis, football, basketball, and the like. Or step
                    into the casual style and comfort offered by sandals,
                    sliders, and flip-flops. Explore our lineup of fashionable
                    footwear for ladies, including pumps, heeled boots,
                    wedge-heels, and pencil-heels. Or enjoy the best of comfort
                ...
                <li className="pt-2">
                  ...
                  <span style={{ fontSize: "14px" }}>
                    &nbsp; Myntra is one of the best online shopping sites for
                    classy accessories that perfectly complement your outfits.
                    You can select smart analogue or digital watches and match
                    them up with belts and ties. Pick up spacious bags,
                    backpacks, and wallets to store your essentials in style.
                    Whether you prefer minimal jewellery or grand and sparkling
                    pieces, our online jewellery collection offers you many
                    impressive options.
                  </span>
                </li>
                <li className="pt-2">
                  ...
                  <span style={{ fontSize: "14px" }}>
                    &nbsp;Online shopping for kids at Myntra is a complete joy.
                    Your little princess is going to love the wide variety of
                    pretty dresses, ballerina shoes, headbands and clips.
                    Delight your son by picking up sports shoes, superhero
                    T-shirts, football jerseys and much more from our online
                    store. Check out our lineup of toys with which you can
            ...
            <div className="my-4">
              ...
              <div style={{ fontSize: "14px" }}>
                ...
                market. You can get your hands on the trendiest style every
                season in western wear. You can also avail the best of ethnic
                fashion during all Indian festive occasions. You are sure to be
            ...
            <div className="my-4">
              ...
              <div style={{ fontSize: "14px" }}>
                ...
                the form of Insider Points. <br></br>
                <br></br>There are four levels to achieve in the program, as the
                Insider Points accumulate. They are - Insider, Select, Elite or
                Icon. Apart from offering discounts on Myntra and partner
            ...
            <div className="my-4">
              ...
              <div style={{ fontSize: "14px" }}>
                ...
                overwhelming surge of online content. It was for this very
                ...
                filter content, increasing user engagement, retention and
                customer loyalty.
                <br></br>
                Myntra is one such online shopping website that joins the list
                of platforms that help curate a personalised fashion feed. Named
              ...
              <ol className="pt-3">
                ...
                <li className="pt-2">
                  ...
                  <div className="pt-2" style={{ fontSize: "14px" }}>
                    ...
                    celebrities in a matter of clicks.<br></br>
                    <br></br> If you are very particular when it comes to the
                    content you wish to view and engage with on social media,
                    the ability to intricately filter content helps achieve
                    that. Applying the same formula for hardcore fashion lovers
                    and shoppers, Myntra Studio brings you a daily fashion fix
                    incorporating everything that you love, all at one place.
                    Sign up on Myntra today and start organising your fashion
            ...
            <div className="my-4">
              ...
              <div style={{ fontSize: "14px" }}>
                ...
                special perks on all your shopping with the Myntra app. Download
                the Myntra app on your Android or IOS device today and
